...
<script src="<?php echo base_url() ?>my-assets/js/admin_js/json/deal.js"></script>
<?php
...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open('update_deal', array('class' => 'form-vertical', 'id' => 'insert_quotation')) ?>
            <input type="hidden" name="id" value="<?php echo $edit_deal[0]['deal_id']; ?>">
            <div class="panel-body">
                <div class="form-group row">
                    <div class="col-sm-6">
                        <label for="customer" class="col-sm-4 col-form-label">Deal Name <i class="text-danger">*</i></label>
                        <div class="col-sm-8">
                            <input type="text" name="deal_name" value="<?php echo $edit_deal[0]['deal_name']; ?>" class="form-control" required placeholder="Deal Name">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <label for="expected_weight" class="col-sm-4 col-form-label">Deal Price</label>
                        <div class="col-sm-8">
                            <input type="number" value="<?php echo $edit_deal[0]['deal_price']; ?>" name="deal_price" placeholder="Price of Deal" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="table-responsive margin-top10">
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                ...
                                <tbody id="addinvoiceItem">
                                    <?php
                                    foreach ($edit_deal as $edit_receipe_val) {
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="quantity[]" value="<?php echo $edit_receipe_val['quantity']; ?>" class="form-control text-right " tabindex="6" />
                                            </td>
                                            <td>
...
<script src="<?php echo base_url() ?>my-assets/js/admin_js/deal.js"></script>