<div class="sidebar">
    ...
    <ul class="sidebar-menu">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('manage_purchase', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            ...
                                            ?>"><a href="<?php echo base_url('peoduction_form') ?>"><?php echo ('Production Form') ?></a></li>
                    <?php } ?>

                    <?php if ($this->permission1->method('manage_purchase', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            if ($this->uri->segment('1') == ("receipe_form")) {
                                                echo "active";
                                            } else {
                                                echo " ";
                                            }
                                            ?>"><a href="<?php echo base_url('receipe_form') ?>"><?php echo ('Receipe Form') ?></a></li>
                    <?php } ?>

                    <?php if ($this->permission1->method('manage_purchase', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            if ($this->uri->segment('1') == ("receipe_manage")) {
                                                echo "active";
                                            } else {
                                                echo " ";
                                            }
                    ...
                    <?php if ($this->permission1->method('manage_purchase', 'read')->access()) { ?>
                        <li class="treeview <?php
                                            ...
                                            ?>"><a href="<?php echo ('wastage_form') ?>"><?php echo ('Wastage Form') ?></a></li>
                    <?php } ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if ($this->permission1->method('profit_report', 'read')->access()) { ?>
                        <li class="treeview <?php if ($this->uri->segment('1') == ("profit_report")) {
                                                ...
                                                echo " ";
                                            } ?>"><a href="<?php echo base_url('waste_item_report') ?>"><?php echo ('Waste Item Report') ?></a></li>
                    <?php } ?>
        ...
        <?php if ($this->session->userdata('isAdmin')) { ?>
            <li class="treeview"><a href="<?php echo base_url('addon/module/index') ?>"><i class="fa fa-adn"></i> <span><?php echo display('addon'); ?></span></a></li>
