<script src="<?php echo base_url() ?>my-assets/js/admin_js/waste.js" type="text/javascript"></script>
                    ...
                    <table class="table table-bordered table-hover" id="purchaseTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?php echo ('Waste') ?> <i class="text-danger">*</i></th>
                                <th class="text-center"><?php echo ('Lose') ?><i class="text-danger">*</i></th>
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                <td class="span3 supplier">
                                    <input type="text" name="product_name" required class="form-control product_name productSelection" onkeypress="product_pur_or_list_west(1);" placeholder="<?php echo display('product_name') ?>" id="product_name_1" tabindex="5">
