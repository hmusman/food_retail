...
$(document).ready(function () {
  ...
  var purchasedatatable = $('#PurOrderList').DataTable({
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'warehouse/warehouse/CheckPurchaseOrderList',
      "data": function (data) {
...
$(document).ready(function () {
  ...
  var base_url = $("#base_url").val();
  var currency = $("#currency").val();
  var purchasedatatable = $('#ProdOrderList').DataTable({
    responsive: true,
    ...
    'serverMethod': 'post',
    'ajax': {
      'url': base_url + 'warehouse/warehouse/CheckProductionOrderList',
      "data": function (data) {
        data.fromdate = $('#from_date').val();
        data.todate = $('#to_date').val();
        data.csrf_test_name = csrf_test_name;
